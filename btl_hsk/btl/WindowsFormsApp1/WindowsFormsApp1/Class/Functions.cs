...
namespace WindowsFormsApp1.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=21AK22-COM\SQLEXPRESS;Initial Catalog=QUANLYGIANGDAY;Integrated Security=True";
            Con.Open();                  //Mở kết nối
                                         //Kiểm tra kết nối
            if (Con.State == ConnectionState.Open)

                MessageBox.Show("Kết nối thành công", "xin chào Quân ");
            else MessageBox.Show("Không thể kết nối với dữ liệu");

        }
        private static string stringConnection = @"Data Source=21AK22-COM\SQLEXPRESS;Initial Catalog=QUANLYGIANGDAY;Integrated Security=True";
